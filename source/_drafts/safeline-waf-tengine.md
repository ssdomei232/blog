...
categories: 
- 学习笔记
index_img: /img/2024/safeline-waf-tengine/
banner_img: /img/2024/safeline-waf-tengine/
...
```
### 1 tengine配置在当前设备环境上不合法
[雷池文档](https://docs.waf-ce.chaitin.cn/zh/%E5%B8%B8%E8%A7%81%E9%97%AE%E9%A2%98%E6%8E%92%E6%9F%A5)
```
# 执行时间根据网站数量和配置情况而定， 请耐心等待
cd /data/safeline && bash reset_tengine.sh
```
